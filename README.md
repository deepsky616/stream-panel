...
3. 사용할 엣지 또는 크롬의 `확장 관리 열기`를 누릅니다.
4. 브라우저의 개발자 모드를 켜고 `압축 해제된 확장 기능을 불러오기`를 누릅니다.
5. 앞에서 연 `browser-extension` 폴더를 선택합니다.
6. 스트림 패널로 돌아가 해당 브라우저의 `연결 시험`을 누릅니다.
7. 오른쪽 액션 목록의 `웹 업무`에서 원하는 키를 패널에 놓습니다.

...
패널 표시 단축키를 누른 뒤 눈에 보이는 키 순서대로 `1`, `2`, `3`을 누르는 것이 가장 빠른 사용 경로입니다. 빈 슬롯은 번호에서 빠집니다.
...
- 설정의 `전역 숫자 단축키`를 켜면 패널을 띄우지 않고 현재 페이지의 앞쪽 열 개 키를 실행할 수 있습니다. 충돌한 번호는 설정 화면에 표시됩니다.
